      ...
      <div class="panel panel-default">  
			  ...
			  <table class="table">
				<tbody>
					...
					<tr> 
			       		<td>수 량</td> 		
			       		<td><input type="text" name="stock" id="stock" value="${requestScope.product.stock}"/></td>
			       	</tr>
